#(C)Tsubasa Kato - 2024/6/25 - Inspire Search Corporation - https://www.inspiresearch.io/en
#Created with the help of Perplexity AI. Tested to work on Qiskit 1.1.0. 
import numpy as np
